...
int main(int argc, char *argv[])
{
	...
	int	Spectro_Size=5E7; /*This is the assumed length of the galaxy file */
	double	*RA_s, /* Given */
		*Dec_s, /* Given */
		*Redshift_s, /*Given */
	...
	int 	Imaging_Size=6E7; /*This is the assumed length of the imaging file */
	double  *RA_i, /* Given */
		*Dec_i; /* Given */
...
/*Read in Args */
	...
	if(argc < 9)
	{
		fprintf(stderr,"Usage measure_wp spectro_file imaging_file polygon_fil start_bin end_bin Nbins Njackknife NormChoise >outfile \n");
		return -1;
...
*/
	...
	fprintf(stderr,"BOSS Wp > There are %d Galaxies in the Spectro Sample.\n",Ngal_s);	
...
/*Read in Imaging File*/
	...
	fprintf(stderr,"BOSS Wp > There are %d Galaxies in the Imaging Sample.\n",Ngal_i);
...
*/
	...
	jackknife_it(N_Jackknife,Polygon_File,Sector_s,Jackknife_s,Ngal_s,RA_s,Dec_s,&area_tot);
	fprintf(stderr,"Done with Spectro Jackknife, Beginning Imaging\n");
	jackknife_it(N_Jackknife,Polygon_File,Sector_i,Jackknife_i,Ngal_i,RA_i,Dec_i,&area_tot);
...
//						fprintf(fp3,"%d %lf %d %d %d %d \n",bin, rp,Jackknife_s[i],Sector_s[i],Jackknife_i[j],Sector_i[j]);
