...
/home/piscioja/Clustering/Boss/Source/Vpac_Codes/measure_Boss_wp_nojack $Rs $Ri 0.01 10 20 2 > RsRi_nojack.out.littleh & 
...
#done
/home/piscioja/Clustering/Boss/Source/Vpac_Codes/measure_Boss_wp_nojack $Ds $Di 0.01 10 20 1 > ${i}_DsDi_nojack.out.littleh &
/home/piscioja/Clustering/Boss/Source/Vpac_Codes/measure_Boss_wp_nojack $Ds $Ri 0.01 10 20 2 > ${i}_DsRi_nojack.out.littleh &
/home/piscioja/Clustering/Boss/Source/Vpac_Codes/measure_Boss_wp_nojack $Rs $Di 0.01 10 20 1 > ${i}_RsDi_nojack.out.littleh &
